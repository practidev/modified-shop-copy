# -----------------------------------------------------------------------------------------
#  $Id: modified.sql 15700 2024-01-17 11:49:46Z Tomcraft $
#
...
CREATE TABLE admin_access (
  ...
  avalex INT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE banners (
  ...
  banners_image_title VARCHAR(255) NOT NULL,
  banners_image_alt VARCHAR(255) NOT NULL,
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'CURRENT_TEMPLATE', 'tpl_modified_nova', 1, 26, NULL, NOW(), NULL, 'xtc_cfg_pull_down_template_sets(');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_ADDRESS_BOOK_ENTRIES', '20', 3, 1, NULL, NOW(), NULL, NULL);
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_RANDOM_SELECT_REVIEWS', '100', 3, 10, NULL, NOW(), NULL, NULL);
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_RANDOM_SELECT_NEW', '100', 3, 11, NULL, NOW(), NULL, NULL);
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_RANDOM_SELECT_SPECIALS', '100', 3, 12, NULL, NOW(), NULL, NULL);
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_DISPLAY_CROSS_SELLS', '0', 3, 16, NULL, NOW(), NULL, NULL);
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_DISPLAY_REVERSE_CROSS_SELLS', '0', 3, 16, NULL, NOW(), NULL, NULL);
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_DISPLAY_SEARCH_AC_RESULTS', '10', 3, 24, NULL, NOW(), NULL, NULL);
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'IMAGE_TYPE_EXTENSION', 'default', 4, 1, NULL, NOW(), NULL, 'xtc_cfg_image_extension(');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'IMAGE_MANIPULATOR', 'image_manipulator.php', 6, 1, NULL, NOW(), NULL, NULL);
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'DISPLAY_ERROR_REPORTING_LEVEL', 'error', 10, 9, NULL, NOW(), 'xtc_set_log_level', 'xtc_cfg_select_option(array(\'none\', \'error\', \'warning\', \'notice\', \'dev\'),');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'SMTP_AUTH_TYPE', 'PLAIN', 12, 8, NULL, NOW(), NULL, 'xtc_cfg_select_option(array(\'none\', \'PLAIN\', \'LOGIN\', \'CRAM-MD5\', \'XOAUTH2\'),');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'REVIEWS_PURCHASED_INFOS', '', 17, 32, NULL, NOW(), NULL, 'xtc_cfg_select_content(\'REVIEWS_PURCHASED_INFOS\',');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'SEARCH_RESULTS_SORT', 'ASC', '22', '12', NULL, NOW(), NULL, 'xtc_cfg_select_option(array(\'ASC\', \'DESC\'),');
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'SEARCH_RESULTS_FIELD', 'pd.products_name', '22', '13', NULL, NOW(), NULL, 'xtc_cfg_select_option(array(\'p.products_price\', \'pd.products_name\', \'p.products_date_added\', \'p.products_model\', \'p.products_ordered\', \'p.products_sort\', \'p.products_weight\', \'p.products_quantity\'),');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'CAT_VIEW_DROPDOWN', 'true', 1000, 27, NULL, NOW(), NULL, 'xtc_cfg_select_option(array(\'true\', \'false\'),');
...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'MAX_DISPLAY_LIST_PRODUCTS', '50', 1000, '-1', NULL , NOW(), NULL , NULL);
...
INSERT INTO content_manager VALUES (24, 0, 0, '', 2, 'Lieferzeit', 'Lieferzeit', 'Die Frist für die Lieferung beginnt bei Zahlung per Vorkasse am Tag nach Erteilung des Zahlungsauftrags an das überweisende Kreditinstitut bzw. bei anderen Zahlungsarten am Tag nach Vertragsschluss zu laufen und endet mit dem Ablauf des letzten Tages der Frist. Fällt der letzte Tag der Frist auf einen Samstag, Sonntag oder einen am Lieferort staatlich anerkannten allgemeinen Feiertag, so tritt an die Stelle eines solchen Tages der nächste Werktag.', 0, 1, '', 1, 10, 0, '', '', '', '', '1', 0, NOW(), NULL);
INSERT INTO content_manager VALUES (25, 0, 0, '', 2, 'E-Mail Signatur', '', 'Firma<br />Adresse<br />Ort<br />Homepage<br />E-Mail:<br />Fon:<br />Fax:<br />USt-IdNr.:<br />Handelsregister<br />Geschäftsführer:', 0, 1, '', 0, 11, 0, '', '', '', '', '0', 0, NOW(), NULL);
INSERT INTO content_manager VALUES (26, 0, 0, '', 2, 'Rechnungsdaten', 'Firma - Adresse - PLZ Stadt', 'Firma<br/>Adresse<br/>PLZ Stadt<br/><br/>Tel: 0123456789<br/>E-Mail: info@shop.de<br/>www: www.shopurl.de<br/><br/>IBAN: DE123456789011<br/>BIC: BYLEMDNE1DE<br/><br/>Diese Daten können im Content Manager geändert werden.', 0, 1, '', 0, 12, 0, '', '', '', '', '0', 0, NOW(), NULL);
INSERT INTO content_manager VALUES (27, 0, 0, '', 2, 'Mein Schnellkauf', 'Mein Schnellkauf', '<p>Mit &bdquo;Mein Schnellkauf&ldquo; können Sie Ihre Bestellung jetzt noch einfacher und vor allem schneller tätigen.</p><p>Sie finden auf der Detailseite eines jeden Artikels unterhalb des Warenkorb-Buttons die Schaltfläche &bdquo;<strong>Mein Schnellkauf aktivieren</strong>&ldquo;, wo Sie die für den Schnellkauf gewünschte Versandart, Bezahlart, Versandadresse und Rechnungsadresse hinterlegen müssen um die Funktion zu aktivieren.<br />Anschließend finden Sie an den folgenden Stellen im Shop den Button zur Bestellung mit &bdquo;<strong>Mein Schnellkauf</strong>&ldquo;:</p><ul><li>Artikel-Detailseite</li><li>Warenkorb</li><li>Mein Konto &raquo; Meine Bestellungen</li><li>Mein Konto &raquo; Meine Bestellungen &raquo; Detailseite der Bestellung</li></ul><p>Um die Voreinstellungen für &bdquo;Mein Schnellkauf&ldquo; zu ändern, gehen Sie auf &bdquo;Mein Konto&ldquo; &raquo; &bdquo;<strong>Mein Schnellkauf bearbeiten</strong>&ldquo;.</p>', 0, 1, '', 0, 13, 1, '', '', '', '', '1', 0, NOW(), NULL);
INSERT INTO content_manager VALUES (28, 0, 0, '', 2, 'Informationen zur Echtheit der Kundenbewertungen', 'Informationen zur Echtheit der Kundenbewertungen', 'Fügen Sie hier Ihre Informationen zur Echtheit der Kundenbewertungen ein.<br /><h2>Textvorschläge [Zutreffendes auswählen]</h2><br /><h3>Keine Überprüfung der Echtheit von Kundenbewertungen</h3><br />Die Bewertungen werden vor ihrer Veröffentlichung nicht auf ihre Echtheit überprüft. Sie können daher auch von Verbrauchern stammen, die die bewerteten Produkte tatsächlich gar nicht erworben/genutzt haben.<br /><br />--- oder ---<br /><br /><h3>Überprüfung der Echtheit von Kundenbewertungen</h3><br />Jede Verbraucherbewertung wird vor ihrer Veröffentlichung auf ihre Echtheit überprüft, sodass sichergestellt ist, dass Bewertungen nur von Verbrauchern stammen, die die bewerteten Produkte auch tatsächlich erworben/genutzt haben.<br /><br />Die Überprüfung geschieht [Zutreffendes auswählen]<br /><ul><li>durch manuelle Überprüfung in Form eines Abgleichs der Bewertung mit der Bestellhistorie des Warenwirtschaftssystems, um einen vorangegangenen Produkterwerb zur notwendigen Bedingung für die Veröffentlichung zu machen.</li><li>durch Übermittlung individualisierter Links an Verbraucher nach Abschluss einer Online-Bestellung, die zu einem Online-Bewertungsformular führen und die sicherstellen, dass der Zugang zur Bewertungsfunktion nur solchen Verbrauchern gewährt wird, die ein Produkt auch tatsächlich erworben haben</li></ul>', 0, 1, '', 0, 14, 1, '', '', '', '', '1', 0, NOW(), NULL);
