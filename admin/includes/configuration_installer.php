<?php
/* -----------------------------------------------------------------------------------------
   $Id: configuration_installer.php 15644 2023-12-21 06:39:01Z GTB $
...
//configuration_group_id 7 --- "Versandoptionen"
  ...
  $values[] = "(NULL, 'SHOW_SHIPPING_MODULE_TITLE', 'shipping_default', '7', '10', NULL, NOW(), NULL, 'xtc_cfg_select_option(array(\'shipping_default\', \'shipping_title\', \'shipping_custom\'), ');";
...
//configuration_group_id 10 --- "Logging Optionen"
  ...
  $values[] = "(NULL, 'DISPLAY_ERROR_REPORTING_LEVEL', 'error', '10', '9', NULL, NOW(), 'xtc_set_log_level', 'xtc_cfg_select_option(array(\'none\', \'error\', \'warning\', \'notice\', \'dev\'),');";
...
//configuration_group_id 1000 --- "Adminbereich"
  ...
  $values_update[] = array (
                           'values' => "configuration_group_id = '1000', sort_order = '-1'",
                           'configuration_key' => 'MAX_DISPLAY_LIST_PRODUCTS'
                           );
