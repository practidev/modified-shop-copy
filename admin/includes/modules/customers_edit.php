<?php
 /*-------------------------------------------------------------
   $Id: customers_edit.php 14980 2023-02-09 16:20:29Z GTB $
  ...
  defined( '_VALID_XTC' ) or die( 'Direct Access to this location is not allowed.' );
      ...
      <div class="div_box mrg5">
        ...
        <div class="main mrg5"><input type="submit" class="button" onclick="this.blur();" value="<?php echo ((isset($_GET['edit']) && $_GET['edit'] == 0) ? BUTTON_INSERT : BUTTON_UPDATE); ?>"><?php echo ' <a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS, xtc_get_all_get_params(array('action', 'edit', 'saction')).(($saction) ? 'action=address_book' : '')) .'">' . BUTTON_CANCEL . '</a>'; ?></div>
