<?php
 /*-------------------------------------------------------------
   $Id: orders_info_blocks.php 15633 2023-12-08 10:47:12Z GTB $
            ...
            <?php
              ...
              ?>
                <tr>
                  ...
                  <td class="main"><?php echo shipping::shipping_title($order->info['shipping_class'], $order->info['shipping_method']) . ' ('.$order->info['shipping_class'].')'; ?></td>
                </tr>
              <?php
              }
