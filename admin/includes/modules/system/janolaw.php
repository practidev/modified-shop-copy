<?php
/* -----------------------------------------------------------------------------------------
   $Id: janolaw.php 15228 2023-06-13 12:09:03Z Tomcraft $
   ...
   (c) 2005 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: janolaw.php 15228 2023-06-13 12:09:03Z Tomcraft $)
    ...
    if (!isset($this->_check)) {
      if (defined('MODULE_JANOLAW_STATUS')) {
        ...
        $check_query = xtc_db_query("SELECT configuration_value 
                                      ...
                                      WHERE configuration_key = 'MODULE_JANOLAW_STATUS'");
