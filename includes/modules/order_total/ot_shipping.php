<?php
/* -----------------------------------------------------------------------------------------
   $Id: ot_shipping.php 14841 2022-12-16 11:04:49Z GTB $
...
class ot_shipping {
  ...
  function process() {
    ...
    if (xtc_not_null($order->info['shipping_method']) && isset($GLOBALS[$module]) && is_object($GLOBALS[$module])) {
      ...
      $tax = $xtPrice->xtcAddTax($order->info['shipping_cost'], $shipping_tax, false) - $order->info['shipping_cost'];
          ...
          )
      {
        if ($_SESSION['customers_status']['customers_status_show_price_tax'] == 1) {
          ...
          $order->info['shipping_cost'] = $xtPrice->xtcAddTax($order->info['shipping_cost'], $shipping_tax, false);
          $order->info['tax'] += $tax;
