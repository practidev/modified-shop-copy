<?php
/* -----------------------------------------------------------------------------------------
   $Id: paypaleps.php 15372 2023-07-20 06:56:18Z GTB $
...
class paypaleps extends PayPalPaymentV2 {
  ...
  function __construct() {
    ...
    $this->allowed_zones = array('AT');

    PayPalPaymentV2::__construct('paypaleps');
  ...
  function keys() {
    return array(
      'MODULE_PAYMENT_PAYPALEPS_STATUS', 
      'MODULE_PAYMENT_PAYPALEPS_ALLOWED', 
      'MODULE_PAYMENT_PAYPALEPS_ZONE',
      'MODULE_PAYMENT_PAYPALEPS_SORT_ORDER'
    );
  }
