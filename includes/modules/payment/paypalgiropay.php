<?php
/* -----------------------------------------------------------------------------------------
   $Id: paypalgiropay.php 15372 2023-07-20 06:56:18Z GTB $
...
class paypalgiropay extends PayPalPaymentV2 {
  ...
  function keys() {
    return array(
      'MODULE_PAYMENT_PAYPALGIROPAY_STATUS', 
      'MODULE_PAYMENT_PAYPALGIROPAY_ALLOWED', 
      'MODULE_PAYMENT_PAYPALGIROPAY_ZONE',
      'MODULE_PAYMENT_PAYPALGIROPAY_SORT_ORDER'
    );
  }
