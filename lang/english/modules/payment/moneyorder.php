...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', 'Make payable to:&nbsp;' . (defined('MODULE_PAYMENT_MONEYORDER_PAYTO') ? nl2br(MODULE_PAYMENT_MONEYORDER_PAYTO) : '') . '<br />Purpose of payment: %s<br />Total amount: %s<br /><br />Send to:<br /><br />' . nl2br(STORE_OWNER) . '<br /><br />' . 'Your order will not ship until we receive payment!');
