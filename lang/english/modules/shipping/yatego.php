...
define('MODULE_SHIPPING_YATEGO_TEXT_TITLE', 'Shipping specified through Yatego');
define('MODULE_SHIPPING_YATEGO_TEXT_DESCRIPTION', 'Shipping specified through Yatego');
define('MODULE_SHIPPING_YATEGO_SORT_ORDER', 'Sort Order');
define('MODULE_SHIPPING_YATEGO_TEXT_WAY', 'Shipping specified through Yatego');
...
define('MODULE_SHIPPING_YATEGO_STATUS_TITLE', 'Enable Self Pickup');
...
define('MODULE_SHIPPING_YATEGO_SORT_ORDER_DESC', 'Sort order of display.');