<?php
/* -----------------------------------------------------------------------------------------
   $Id: it_recht_kanzlei.php 13930 2022-01-11 13:42:38Z Tomcraft $
...
define('MODULE_API_IT_RECHT_KANZLEI_TYPE_AGB_DESC', 'Please specify in which page this legal text is to be inserted automatically.');
define('MODULE_API_IT_RECHT_KANZLEI_TYPE_DSE_TITLE', 'Legal Text Privacy');
