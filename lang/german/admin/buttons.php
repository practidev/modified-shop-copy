<?php
/* --------------------------------------------------------------
   $Id: buttons.php 15169 2023-05-10 17:01:45Z GTB $
...
define('BUTTON_STATUS', 'Kundengruppe');
define('BUTTON_ACCOUNTING', 'Adminrechte');
define('BUTTON_ORDERS', 'Bestellungen');
...
define('BUTTON_NEW_ATTACHMENT', 'Neuer Anhang');
...
define('BUTTON_NEW_LANGUAGE', 'Neue Sprache');
define('BUTTON_NEW_COUNTRY', 'Neues Land');
define('BUTTON_NEW_CURRENCY', 'Neue W&auml;hrung');
