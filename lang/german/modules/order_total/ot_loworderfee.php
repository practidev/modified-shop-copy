...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_ORDER_UNDER_INTERNATIONAL_TITLE','Mindermengenzuschlag f&uuml;r internationale Bestellungen unter');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_ORDER_UNDER_INTERNATIONAL_DESC','Mindermengenzuschlag wird f&uuml;r internationale Bestellungen unter diesem Wert hinzugef&uuml;gt.');
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_FEE_INTERNATIONAL_TITLE','Zuschlag International');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_FEE_INTERNATIONAL_DESC','Mindermengenzuschlag International.');
