<?php
/* -----------------------------------------------------------------------------------------
   $Id: moneyorder.php 15243 2023-06-15 05:34:46Z GTB $   
  ...
  define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', 'Bankverbindung:<br />' . (defined('MODULE_PAYMENT_MONEYORDER_PAYTO') ? nl2br(MODULE_PAYMENT_MONEYORDER_PAYTO) : '') . '<br />Verwendungszweck: %s<br />Gesamtbetrag: %s<br /><br />Kontoinhaber:<br />' . nl2br(STORE_OWNER) . '<br /><br />' . 'Ihre Bestellung wird nach Geldeingang auf unserem Konto an Sie versendet.');
