...
define('MODULE_SHIPPING_AMAZON_TEXT_DESCRIPTION', 'Versand festgelegt durch Amazon');
define('MODULE_SHIPPING_AMAZON_SORT_ORDER', 'Sortierung');
...
define('MODULE_SHIPPING_AMAZON_SORT_ORDER_DESC', 'Reihenfolge der Anzeige');
