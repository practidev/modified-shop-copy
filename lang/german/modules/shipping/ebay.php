...
define('MODULE_SHIPPING_EBAY_TEXT_DESCRIPTION', 'Versand festgelegt durch eBay');
define('MODULE_SHIPPING_EBAY_SORT_ORDER', 'Sortierung');
...
define('MODULE_SHIPPING_EBAY_SORT_ORDER_DESC', 'Reihenfolge der Anzeige');
