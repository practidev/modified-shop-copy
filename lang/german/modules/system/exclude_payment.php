<?php
/* -----------------------------------------------------------------------------------------
   $Id: exclude_payment.php 15005 2023-02-16 20:43:46Z Tomcraft $
...
if (defined('MODULE_EXCLUDE_PAYMENT_NUMBER')) {
  for ($module_exclude_payment_i = 1; $module_exclude_payment_i <= (int)MODULE_EXCLUDE_PAYMENT_NUMBER; $module_exclude_payment_i ++) {
    ...
    define('MODULE_EXCLUDE_PAYMENT_SHIPPING_'.$module_exclude_payment_i.'_DESC' , 'W&auml;hlen Sie die Versandart, bei der Sie eine Zahlart ausschlie&szlig;en wollen.');
    define('MODULE_EXCLUDE_PAYMENT_PAYMENT_'.$module_exclude_payment_i.'_TITLE' , $module_exclude_payment_i.'. ausgeschlossene Zahlart');
    define('MODULE_EXCLUDE_PAYMENT_PAYMENT_'.$module_exclude_payment_i.'_DESC' , 'W&auml;hlen Sie die Zahlart, die Sie ausschlie&szlig;en wollen.');
  }
}
?>