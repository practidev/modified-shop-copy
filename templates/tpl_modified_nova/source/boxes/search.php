...
/* -----------------------------------------------------------------------------------------
  ...
  {
    $box_smarty->assign('CATEGORIES', xtc_draw_pull_down_menu('categories_id', xtc_get_categories(array(array('id' => '', 'text' => TEXT_AC_ALL_CATEGORIES)), 0, false), isset($_GET['categories_id']) ? (int)$_GET['categories_id'] : '', 'aria-label="'.TEXT_ALL_CATEGORIES.'" id="cat_search"').xtc_draw_hidden_field('inc_subcat', '1'));
  }
